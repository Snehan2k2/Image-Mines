...
if __name__ == "__main__":
    ...
    parser.add_argument("--parquet-path", type=str, default='/home/FRACTAL/kalash.shah/ImageMines/dataset/TextVQA/validation-00000-of-00003.parquet')
    parser.add_argument("--pkl-path", type=str, default='/home/FRACTAL/snehan.j/LLaVA-NeXT/attn-eval-final/textvqa.pkl')
